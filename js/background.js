...
const bgImage = document.createElement("img"); //여기서 image는 태그 이름
// 문자열 만들기
bgImage.src = `img/${chosenImage}`;  //이건 HTML에서 <img src="img/파일"> 과 같은 코드이다. 여기서 image는 폴더 이름
...
//코드라인 10,12,17을 JS파일에서 하면 HTML에서 <img src="img/이미지파일명"> 한 것과 같은 방법이다.
